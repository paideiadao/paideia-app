...
import { FormGroup, FormControlLabel, Switch, IconButton, useTheme } from "@mui/material";
...
const DarkSwitch: React.FC = () => {
  ...
  return (
    ...
    >
      {(theme === DarkTheme) ? <Brightness7Icon sx={{ fontSize: '18px' }} /> : <Brightness4Icon sx={{ fontSize: '18px' }} />}
    </IconButton>
  );
};
